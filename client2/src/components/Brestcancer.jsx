...
const Brestcancer = () => {
  ...
  return (
    <div className="relative flex items-center justify-center h-[99vh] w-[99vw] bg-black overflow-hidden">
      ...
      <div
        className="h-[99vh] absolute flex items-center justify-center  left-[-5rem] w-[25rem] bg-gradient-to-r from-[#3a0ca3] via-[#7209b7] to-[#4361ee] shadow-xl"
        style={{ clipPath: "polygon(0 0, 100% 32%, 100% 68%, 0 100%)" }}
      >
        {/* <div
          className="h-[13rem] flex items-center justify-center w-[16rem] ml-11 bg-black"
